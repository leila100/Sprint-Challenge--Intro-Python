...
validLetters = ['c', 'd', 'e', 'f', 'g']
print("Starts between C and G, inclusive:")
c = [human.name for human in humans if human.name[0].lower() in validLetters]
print(c)
...
f = [(human.name, human.age)
     for human in humans if int(human.age) >= 27 and int(human.age) <= 32]
print(f)
